...
./legit-add.sh normalfile.txt > my_stdout 2> my_stderr 
...
./legit-add.sh nonexistant_file.txt > my_stdout 2> my_stderr 
diff my_stderr reference_stderr 
diff my_stdout reference_stdout 
...
./legit-add.sh > my_stdout 2> my_stderr 
diff my_stderr reference_stderr 
diff my_stdout reference_stdout 
...
./legit-add.sh .badfile > my_stdout 2> my_stderr 
diff my_stderr reference_stderr 
diff my_stdout reference_stdout 
...
./legit-add.sh _badfile > my_stdout 2> my_stderr 
diff my_stderr reference_stderr 
diff my_stdout reference_stdout 
#usage: legit-add <filenames>
...
rm -rf ".legit"
./legit-init.sh
./legit-add.sh ok.file.txt > my_stdout 2> my_stderr
diff my_stderr reference_stderr 
diff my_stdout reference_stdout  
...
rm -rf ".legit"
./legit-init.sh
./legit-add.sh ok_file.txt > my_stdout 2> my_stderr 
diff my_stderr reference_stderr 
diff my_stdout reference_stdout 
...
./legit-add.sh test-dir > my_stdout 2> my_stderr 
diff my_stderr reference_stderr 
diff my_stdout reference_stdout 
...
./legit-add.sh ok.file.txt _badfile > my_stdout 2> my_stderr 
diff my_stderr reference_stderr 
diff my_stdout reference_stdout 
#
#
